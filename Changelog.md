...
* An automated validation is now possible when the parameter doValidation is set to true (and the basicLALogger hides eval stats to show valid ones if there are some)
### Changes
