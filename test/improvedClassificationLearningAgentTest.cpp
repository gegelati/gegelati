...
TEST_F(ImprovedClassificationLearningAgentTest, Constructor)
{
   ...
   ASSERT_NO_THROW(
       cla = new Learn::ImprovedClassificationLearningAgent<Learn::LearningAgent>(
           fle, set, params, TPG::TPGFactory(), type))
   ...
   ASSERT_NO_THROW(pcla = new Learn::ImprovedClassificationLearningAgent<
                       Learn::ParallelLearningAgent>(fle, set, params, TPG::TPGFactory(), type))
       << "Error when building a ClassificationLearningAgent.";
