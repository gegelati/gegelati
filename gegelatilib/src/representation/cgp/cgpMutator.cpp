...
void Representation::CGP::CGPMutator::initRandomSpecificAgent(const Agent& agent, EvoGraph::Graph& graph, AgentManager& manager, const RepresentationParameters& params, RNG::RNG& rng)
{
...
void Representation::CGP::CGPMutator::insertRandomLine(const LGP::LGPAgent& agent, LGP::LGPManager& manager, const RepresentationParameters& params, RNG::RNG& rng)
{
...
bool Representation::CGP::CGPMutator::mutateLGPAgent(const LGP::LGPAgent& agent, LGP::LGPManager& manager, const RepresentationParameters& params, RNG::RNG& rng)
{
...
bool Representation::CGP::CGPMutator::alterRandomlyLine(
    const LGP::LGPAgent& agent, size_t lineIndex, LGP::LGPManager& manager, const RepresentationParameters& params, RNG::RNG& rng)
{
