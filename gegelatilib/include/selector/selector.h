...
namespace Selector {
    ...
    /**
     * \brief Abstract class for the selection classes, that will choose which agents survived or not at each generation
     */
    class Selector
    {
        protected:
            ...
            std::pair<const TPG::TPGVertex*, std::shared_ptr<Learn::EvaluationResult>>
        ...
        public:
             ...
             * \param[in] results Map from the evaluateAllRoots method.
             */
            virtual void updateResultsPerRoot(const std::multimap<std::shared_ptr<Learn::EvaluationResult>,
                                    const TPG::TPGVertex*>& results);
             ...
             * \param[in] results Map from the evaluateAllRoots method.
             */
            virtual void updateBestRoot(const std::multimap<std::shared_ptr<Learn::EvaluationResult>,
                                    const TPG::TPGVertex*>& results);
