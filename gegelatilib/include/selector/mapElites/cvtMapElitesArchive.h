...
namespace Selector {
    namespace MapElites {
         ...
         * 
         * This class implements a CVT (Centroidal Voronoi Tessellation) based Map Elites Archive
         * It inherits from the MapElitesArchive class.
         */
        class CvtMapElitesArchive : public MapElitesArchive {
            ...
            public:
                 ...
                 * \param[in] nbIterationInit Number of iterations for initialization
                ...
                CvtMapElitesArchive(Mutator::RNG& rng, size_t nbCentroids, size_t nbDescriptors, double minValue, double maxValue, size_t nbIterationInit, size_t nbDotsInit, double a1, double b1, double a2, double b2)
                    : MapElitesArchive(0, nbDescriptors, minValue, maxValue), 
                      nbCentroids{nbCentroids}, 
                      nbIterationInit{nbIterationInit}, 
                      nbDotsInit{nbDotsInit}, 
