...
namespace Representation {
    /**
     * \brief Abstract class representing an AgentManager used by an Representation.
     * 
    ...
    protected:
        ...
        /// Sub-managers for sub-representations
        ...
        /// Managers of aggregated representations
    ...
    public:
         ...
         */
        AgentManager(const Output::OutputHandler& outputs, uint64_t representationID) : outputs{outputs}, representationID{representationID} {}
        ...
        /**
         * \brief return the subManager corresponding to the name of the representation given.
         * 
         * \param[in] representationID name of the representation given.
         */
        virtual AgentManager& getSubManager(uint64_t representationID);
         ...
         * \param[in] representationID name of the representation given.
         */
        virtual const AgentManager& cGetSubManager(uint64_t representationID) const;

        /**
         * \brief return the aggregated manager corresponding to the name of the representation given.
         * 
         * \param[in] representationID name of the representation given.
         */
        virtual const AgentManager& getAggregatedManager(uint64_t representationID) const;
        ...
        /**
         * \brief Create a new Agent of the type used by the current representation.
         * 
        ...
        /**
         * \brief Copy a new Agent of the type used by the current representation.
         * 
        ...
        /**
         * \brief Empty an Agent of the type used by the current representation.
         * 
