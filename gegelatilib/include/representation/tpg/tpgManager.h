...
namespace Representation::TPG {
    ...
    /**
     * \brief Class representing a TPGManager used by the TPGRepresentation.
     * 
    ...
    public:
         ...
         */
        TPGManager(const Output::OutputHandler& outputs, uint64_t representationID) : AgentManager(outputs, representationID) {};
