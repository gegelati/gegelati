...
namespace Representation::TGP {
    ...
    public:
         ...
         *
         */
        virtual void insertRandomSubTree(const LGP::LgpIndividual& agent, size_t destinationIndexLine, size_t maxDepthTree, LGP::LGPPopulation& population, const RepresentationParameters& params, RNG::RNG& rng);
        ...
        /**
         * \brief mutate a specific TGPagent of an representation within a population
         * 
         * \param[in,out] agent the Individual to mutate.
         * \param[in] population the population to change the agents.
         * \param[in] params Probability parameters for the mutation.
         ...
         */
        virtual bool alterRandomLine(const LGP::LgpIndividual& agent, LGP::LGPPopulation& population, const RepresentationParameters& params, RNG::RNG& rng) override;
         ...
         * \param[in] population the population to change the agents.
         */
        virtual void destroySubTree(const LGP::LgpIndividual& agent, size_t idxSubTree, LGP::LGPPopulation& population);

        /**
         * \brief method returning if the node at the corresponding index is pointing to some sub trees.
         */
        std::vector<bool> hasSubTree(const LGP::LgpIndividual& agent, size_t idx);

        /**
         * \brief Method returning the index of the line in the agent corresponding to the destination index indicated
         */
        size_t getIndexLineFromDest(const LGP::LgpIndividual& agent, size_t destIdx);
         ...
         */
        size_t getRealNodeDepth(const LGP::LgpIndividual& agent, size_t destIndex);
         ...
         */
        virtual bool alterRandomOutputs(const LGP::LgpIndividual& agent, LGP::LGPPopulation& population, size_t location, const RepresentationParameters& params, RNG::RNG& rng) override;
         ...
         */
        void changeNodeIndex(const LGP::LgpIndividual& agent, LGP::LGPPopulation& population, size_t lineIndex, size_t destIndex);
