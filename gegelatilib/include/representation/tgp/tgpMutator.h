...
namespace Representation::TGP {
    ...
    public:
         ...
         *
         */
        virtual void insertRandomSubTree(const LGP::LGPAgent& agent, size_t destinationIndexLine, size_t maxDepthTree, LGP::LGPManager& manager, const RepresentationParameters& params, RNG::RNG& rng);
         ...
         */
        virtual bool alterRandomLine(const LGP::LGPAgent& agent, LGP::LGPManager& manager, const RepresentationParameters& params, RNG::RNG& rng) override;
         ...
         */
        virtual bool alterRandomOutputs(const LGP::LGPAgent& agent, LGP::LGPManager& manager, size_t location, const RepresentationParameters& params, RNG::RNG& rng) override;
