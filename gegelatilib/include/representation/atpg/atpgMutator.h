...
namespace Representation::ATPG {
    ...
    protected:
        ...
        /// Name of the action program representation associated with the TPG individuals.
    ...
    public:
        ...
        /**
         * \brief Get the id of the action program representation associated with the TPG individuals.
         * 
