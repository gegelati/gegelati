...
namespace Representation::ATPG {
    ...
    public:
         ...
         */
        ATPGExecutionEngine(const Output::OutputHandler& outputs, uint64_t representationID, bool isTraining = false): TPGExecutionEngine(outputs, representationID, isTraining) {}
