...
namespace Instructions {
	...
	*/
	template <class T>
	class LambdaInstruction < T, typename std::enable_if <Data::is_std_array<T>::value>::type> : public Instruction
	{
	protected:
		/**
		* \brief Function executed for this Instruction.
	...
	public:
		...
		*/
		...
		double execute(
			...
			std::shared_ptr<const T> arg1 = (args.at(0)).getSharedPointer<const T>();
			std::shared_ptr<const T> arg2 = (args.at(1)).getSharedPointer<const T>();
