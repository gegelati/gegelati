...
namespace Algorithm {
    ...
    namespace LGP{
        ...
        public:
            ...
            LGPManager(const Environment& env, const Archive& archive, size_t nbOutputs): env{env}, archive{archive}, nbOutputs{nbOutputs} {};
             ...
             */
            virtual const Archive& getArchive() const;
